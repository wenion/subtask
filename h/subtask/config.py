...
from h.subtask.settings import SettingsManager
...
def configure(environ=None, settings=None):  # pylint: disable=too-many-statements
    ...
    # Configuration for kn
    settings_manager.set(
        "kn.repository", "KN_REPOSITORY", type_=aslist
    )
    settings_manager.set("kn.database", "KN_DATABASE")
    settings_manager.set("kn.model_name", "KN_MODEL_NAME")
